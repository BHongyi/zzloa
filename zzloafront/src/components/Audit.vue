<template>
  <div>
    <el-table
      ...
      style="width: 100%"
    >
      <el-table-column prop="leavetype" label="请假类型" width="180"> </el-table-column>
    ...
    <el-dialog title="审批" :visible.sync="auditDialogVisible" width="550px">
       请假理由： {{auditformdata.leavereason}}
      <el-steps :active="auditformdata.active" finish-status="success" style="width:500px">
        <el-step
